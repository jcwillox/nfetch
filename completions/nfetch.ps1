...
Register-ArgumentCompleter -CommandName $cmdNames -ScriptBlock {
    ...
    __nfetch_debug "WordToComplete: $WordToComplete Command: $Command CursorPosition: $CursorPosition"
    ...
    __nfetch_debug "RequestComp: $RequestComp"
    ...
    __nfetch_debug "New WordToComplete: $WordToComplete"


    # Check for flag with equal sign
    $IsEqualFlag = ($WordToComplete -Like "--*=*" )
    if ( $IsEqualFlag ) {
        __nfetch_debug "Completing equal sign flag"
    ...
    $Values = $Out | ForEach-Object {
        ...
        __nfetch_debug "Name: $Name Description: $Description"
    ...
    if (($Directive -band $ShellCompDirectiveNoSpace) -ne 0 ) {
        ...
        __nfetch_debug "ShellCompDirectiveNoSpace is called"
        $Space = ""
    }
        ...
        switch ($Mode) {
            ...
            "Complete" {
                ...
                if ($Values.Length -eq 1) {
                    __nfetch_debug "Only one completion left"

                    # insert space after value
                    [System.Management.Automation.CompletionResult]::new($($comp.Name | __nfetch_escapeStringWithSpecialChars) + $Space, "$($comp.Name)", 'ParameterValue', "$($comp.Description)")
